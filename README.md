...
- **Framework:** Astro (Elegido por su arquitectura de Zero-JS por defecto y tiempos de carga instantáneos)
...
git clone https://github.com/ErickAndrewBF/portafolio-erick.git
